...
export function sendDebugEvidence(result = {}, error = null) {
  ...
  return {
    ...
    send_control_wait_ms: Number(field("send_control_wait_ms")) || 0,
    send_control_disabled_duration_ms: Number(field("send_control_disabled_duration_ms")) || 0,
    form_inert_duration_ms: Number(field("form_inert_duration_ms")) || 0,
    first_send_ready_at_ms: Number(field("first_send_ready_at_ms")) || 0,
    send_control_readiness_timeline: Array.isArray(field("send_control_readiness_timeline")) ? field("send_control_readiness_timeline") : [],
