...
import { profileTaskCanResume, profileTaskJobsForWorker, profileTaskLastReason, profileTaskProgress, profileTaskStatusLabel, profileWorkerIsIdleForTaskResume } from "./profile-task-popup.js";
...
function ProfileTaskModal({ profile, jobs, resumeBusyTaskId, onClose, onResume }) {
  ...
  async function loadResponse(profile, explicitConversationId, silent = false, readDom = false, recoverStaleDom = false, canonicalOnly = false) {
    ...
    try {
      ...
      setRequestResponses((current) => {
        ...
        const nextTotalMessageCount = protectAuthoritativeSnapshot
        ...
        <section id="profiles">
          ...
          <div className={`profile-list is-${managerSettings.profileLayout === "cards" ? "card" : "row"}-layout working-border-${managerSettings.workingBorderStyle}`}>
            ...
            {[...visibleBrowserProfiles]
              ...
              const profileRepository = repoLabel ? {
                label: repoLabel,
                title: repoTitle
              } : null;
              return (
