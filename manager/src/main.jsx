      ...
      <main className={activePage === "settings" ? "page-settings" : activePage === "logs" ? "page-logs" : activePage === "workflows" ? "page-workflows" : activePage === "control" ? "page-control" : "page-overview"}>
        <header>
          <div>
            ...
            <h1>{activePage === "settings" ? "Cài đặt CodexPro" : activePage === "logs" ? "Nhật ký CodexPro" : activePage === "workflows" ? "Trung tâm quy trình" : activePage === "control" ? "Trung tâm điều phối" : "CodePro Multi Agent"}</h1>
