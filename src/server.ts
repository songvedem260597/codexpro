  ...
  registerCodexTool(
    ...
    "browser_control",
    {
      ...
      inputSchema: {
        ...
        focus_window: z.boolean().optional().describe("For explicit recover_chat_tab actions only, allow the recovered Chrome window to come to the foreground. Automatic recovery leaves this false."),
