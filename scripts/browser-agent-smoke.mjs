...
assert.equal(shouldShowChatSettling({ networkState: "completed", tabSettling: false, responseCurrent: true, responseIncomplete: false, responseReady: false, awaitingAssistant: true }), true, "a completed transport must keep settling while the latest user still has no verified final assistant response");
assert.equal(canAcceptNextChatMessage({ networkState: "completed", tabBusy: false, tabSettling: false, responseCurrent: true, responseBusy: false, responseReady: false, responseIncomplete: false, awaitingAssistant: true }), false, "a completed transport with an unverified latest assistant must reject the next user message instead of mixing turns");
