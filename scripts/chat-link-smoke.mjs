...
assert.equal(manifest.version, "0.5.93", "worker submit acknowledgement fixes must be packaged in a reloadable extension version");
assert.match(managerMain, /const WORKER_EXTENSION_VERSION = "0\.5\.93";/, "Manager updater must require the worker version with strict submit acknowledgement");
