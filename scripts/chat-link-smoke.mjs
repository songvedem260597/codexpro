...
assert.equal(manifest.version, "0.5.126", "post-ACK runtime identity hotfix must be packaged in a reloadable extension version");
assert.match(managerMain, new RegExp(`const WORKER_EXTENSION_VERSION = "${manifest.version.replace(/\\./g, "\\\\.")}";`), "Manager updater must require the packaged worker version");
