...
assert.equal(manifest.version, "0.5.107", "the connector verification fixes must be packaged in a reloadable extension version");
assert.match(managerMain, /const WORKER_EXTENSION_VERSION = "0\.5\.107";/, "Manager updater must require the worker version containing connector verification fixes");
