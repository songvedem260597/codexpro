...
assert.equal(manifest.version, "0.5.119", "background ChatGPT sends and proactive full-conversation rollover must be packaged in a reloadable extension version");
assert.match(managerMain, /const WORKER_EXTENSION_VERSION = "0\.5\.119";/, "Manager updater must require the worker version that preserves Manager focus during rollover");
