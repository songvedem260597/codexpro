...
assert.equal(manifest.version, "0.5.94", "tab inventory reconciliation must be packaged in a reloadable extension version");
assert.match(managerMain, /const WORKER_EXTENSION_VERSION = "0\.5\.94";/, "Manager updater must require the worker version with authoritative tab inventory");
