...
assert.equal(manifest.version, "0.5.103", "the source-Chrome ChatGPT warning lock must be packaged in a reloadable extension version");
assert.match(managerMain, /const WORKER_EXTENSION_VERSION = "0\.5\.103";/, "Manager updater must require the worker version containing the source-Chrome ChatGPT warning lock");
