...
assert.equal(manifest.version, "0.5.97", "the headless guest upload and submit endpoint fix must be packaged in a reloadable extension version");
assert.match(managerMain, /const WORKER_EXTENSION_VERSION = "0\.5\.97";/, "Manager updater must require the worker version containing headless guest upload and submit support");
