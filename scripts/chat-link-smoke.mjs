...
assert.equal(manifest.version, "0.5.99", "the headless guest activity-state fix must be packaged in a reloadable extension version");
assert.match(managerMain, /const WORKER_EXTENSION_VERSION = "0\.5\.99";/, "Manager updater must require the worker version containing headless guest activity-state handling");
