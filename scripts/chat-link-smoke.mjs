...
assert.equal(manifest.version, "0.5.104", "the macOS single-tab preservation fix must be packaged in a reloadable extension version");
assert.match(managerMain, /const WORKER_EXTENSION_VERSION = "0\.5\.104";/, "Manager updater must require the worker version containing the macOS single-tab preservation fix");
